...
(function () {
  ...
  function injectStyles() {
    var css = [
      ...
      'transition:transform 340ms cubic-bezier(.2,.8,.3,1);font-family:"Helvetica Neue",Helvetica,Arial,sans-serif}',
      ...
      '.rc-nl__kicker{font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:.72rem;font-weight:700;',
      'letter-spacing:.16em;text-transform:uppercase;color:#E8621B;margin-bottom:12px}',
      '.rc-nl__title{font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:1.85rem;font-weight:800;',
      ...
      '.rc-nl__btn{padding:14px 20px;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:.9rem;',
      ...
      'font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:1.25rem;font-weight:800;letter-spacing:.14em;',
